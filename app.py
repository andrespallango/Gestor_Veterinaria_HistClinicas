    ...
    if request.method == 'POST':
        ...
        cursor.execute("""
            SELECT
                ...
                NULL AS otras_mascotas_d,
                NULL AS nin_casa_d,
                NULL AS familia_problema_d,
                NULL AS tipo_comida_d,
                NULL AS golosinas_d,
                NULL AS caida_pelo_d,
                NULL AS se_rasca_d,
                NULL AS ambiente_d,
                NULL AS pasa_sol_d,
                NULL AS pasa_tierra_d,
                NULL AS defecacion_d,
                NULL AS parte_enrojecida_d,
                NULL AS fecha_ectoparasitos_d,
                NULL AS descrip_ectoparasitos_d,
                NULL AS duchas_casa_d,
                NULL AS alergia_comida_d,
                NULL AS rasp_cutaneo_d,
                NULL AS tricograma_d,
                NULL AS lampara_wood_d,
                NULL AS reflejo_otopodal_d,
                NULL AS biopsia_d,
                NULL AS citologia_d,
                NULL AS antibiograma_d,
            ...
            SELECT
                id AS id,
                propietario_d AS propietario,
                cedula_d AS cedula,
                direccion_d AS direccion,
                medico_responsable_d AS medico_responsable,
                fecha_creacion_d AS fecha_creacion,
                telefono_d AS telefono,
                nombre_paciente_d AS nombre_paciente,
                fecha_nacimiento_d AS fecha_nacimiento,
                especie_d AS especie,
                raza_d AS raza,
                sexo_d AS sexo,
                color_d AS color,
                vacuna_1_d AS vacuna_1,
                fecha_vacuna_1_d AS fecha_vacuna_1,
                vacuna_2_d AS vacuna_2,
                fecha_vacuna_2_d AS fecha_vacuna_2,
                vacuna_3_d AS vacuna_3,
                fecha_vacuna_3_d AS fecha_vacuna_3,
                vacuna_4_d AS vacuna_4,
                fecha_vacuna_4_d AS fecha_vacuna_4,
                vacuna_5_d AS vacuna_5,
                fecha_vacuna_5_d AS fecha_vacuna_5,
                fecha_ultima_desparasitacion_d AS fecha_ultima_desparasitacion,
                motivo_consulta_d AS motivo_consulta,
                sintomatologia_d AS sintomatologia,
                tratamiento_d AS tratamiento,
                diagnostico_diferencial_d AS diagnostico_diferencial,
                otras_mascotas_d,
                nin_casa_d,
                familia_problema_d,
                tipo_comida_d,
                ...
                defecacion_d,
                parte_enrojecida_d,
                fecha_ectoparasitos_d,
                descrip_ectoparasitos_d,
                duchas_casa_d,
                alergia_comida_d,
                rasp_cutaneo_d,
                tricograma_d,
                ...
                citologia_d,
                antibiograma_d,
                diagnostico_definitivo_d AS diagnostico_definitivo,
                tratamiento_final_d AS tratamiento_final,
                medicamento_1_d AS medicamento_1,
                posologia_medicamento_1_d AS posologia_1,
                medicamento_2_d AS medicamento_2,
                posologia_medicamento_2_d AS posologia_2,
                medicamento_3_d AS medicamento_3,
                posologia_medicamento_3_d AS posologia_3,
                medicamento_4_d AS medicamento_4,
                posologia_medicamento_4_d AS posologia_4,
                medicamento_5_d AS medicamento_5,
                posologia_medicamento_5_d AS posologia_5,
                proxima_cita_d AS proxima_cita
            FROM historia_derma
            WHERE cedula_d = %s
        """, (cedula, cedula))
